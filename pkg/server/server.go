                ...
                <div class="step-item">
                    ...
                    <div>
                        ...
                        <div style="margin-top: 10px; font-size: 0.84rem; color: var(--text-muted); line-height: 1.45;">
                            ...
                            <strong>🐧 Linux:</strong> Ubuntu/Debian users: double-click the <strong>.deb</strong> to install via App Center. Other distros: extract the <strong>.tar.gz</strong> and run <code>install.sh</code>.
                        </div>
                    </div>
                </div>
                <div class="step-item">
